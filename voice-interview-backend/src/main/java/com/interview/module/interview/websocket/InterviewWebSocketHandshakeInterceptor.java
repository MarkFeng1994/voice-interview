...
public class InterviewWebSocketHandshakeInterceptor implements HandshakeInterceptor {
	...
	public InterviewWebSocketHandshakeInterceptor(InterviewWsTicketService interviewWsTicketService) {
	...
	public boolean beforeHandshake(
		...
		try {
			InterviewWsTicketPrincipal principal = interviewWsTicketService.parse(ticket.trim());
